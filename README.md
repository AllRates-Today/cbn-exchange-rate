...
Official **Central Bank of Nigeria** (Nigeria) daily exchange rates in Node.js / TypeScript — ~14 currencies against the NGN, with history back to 2001. Zero dependencies, works in Node 18+, Bun, Deno, and edge runtimes (uses global `fetch`).
...
Powered by [AllRatesToday](https://allratestoday.com/central-bank-rates-api/cbn/). Get a free API key at [allratestoday.com/register](https://allratestoday.com/register) — 300 requests/month, no credit card.
