'use strict';
// Central Bank of Nigeria exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/cbn';
...
/** Latest rate for one pair, e.g. getRate('USD', 'NGN', { apiKey }). */
